...
public class CategoryRequest {
    ...
    public record CategoryCreateRequest(
            ...
            @NotBlank(message = "Slug không được để trống") @Pattern(regexp = "^[a-z0-9-]+$", message = "Slug chỉ hợp lệ với chữ cái thường, số và dấu gạch ngang (-)") String slug,
            ...
            @Min(value = 0, message = "Thứ tự sắp xếp phải lớn hơn hoặc bằng 0") Integer sortOrder) {
    }
