...
@Table(name = "stock_reservations", indexes = {
        ...
        @Index(name = "idx_reservation_created_at_id", columnList = "created_at DESC, id DESC"),
        @Index(name = "idx_reservation_order_sku_warehouse", columnList = "order_id, sku_code, warehouse_id")
})
@Getter
@Setter
@NoArgsConstructor
