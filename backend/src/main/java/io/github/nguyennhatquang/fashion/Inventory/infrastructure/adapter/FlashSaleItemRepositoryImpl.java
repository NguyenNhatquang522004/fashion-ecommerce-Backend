...
public class FlashSaleItemRepositoryImpl implements IFlashSaleItemRepository {
    ...
    @Override
    public ExactPageResponse<FlashSaleItem> getFlashSaleItemExactPage(ExactPageRequest request) {
        ...
        List<FlashSaleItem> responseData = Collections.emptyList();
        ...
        // 4. Trả về Response
        return ExactPageResponse.<FlashSaleItem>builder()
