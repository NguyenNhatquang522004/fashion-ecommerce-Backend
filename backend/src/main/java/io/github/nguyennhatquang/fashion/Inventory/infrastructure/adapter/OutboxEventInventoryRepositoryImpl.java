...
public class OutboxEventInventoryRepositoryImpl implements IOutboxEventInventoryRepository {
    ...
    @Override
    public ExactPageResponse<OutboxEventInventory> getOutboxEventInventoryExactPage(ExactPageRequest request) {
        ...
        List<OutboxEventInventory> responseData = Collections.emptyList();
        ...
        // 4. Trả về Response
        return ExactPageResponse.<OutboxEventInventory>builder()
