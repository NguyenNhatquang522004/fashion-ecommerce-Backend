...
public class STOCK_OUT implements IStrategyInventoryLedger {
    ...
    public InventoryTransactionTypeEnum getType() {
        return InventoryTransactionTypeEnum.STOCK_OUT;
    }
    ...
    public Result<Void, Exception> execute(InventorySummaryCreateRequestv2 request) {
        try {
            ...
            if (inventorySummaryData.getAvailable() < request.onHand()) {
